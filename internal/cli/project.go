...
func newProjectAddCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&opts.User, "user", "", "Linux user for a user-owned project (omit for shared web-user mode)")
	cmd.Flags().StringVar(&opts.Group, "group", "", "Project group for shared mode (default: platform web group)")
